...
<div class="cwh-pubblicazioni-form">
    ...
    <div class="col-lg-6 col-sm-6">
        ...
        $form->field($model, 'cwh_config_id')->dropDownList(
            \yii\helpers\ArrayHelper::map(open20\amos\cwh\models\CwhConfig::find()->all(), 'id', 'id'),
    ...
    <div class="col-lg-6 col-sm-6">
        ...
        $form->field($model, 'cwh_regole_pubblicazione_id')->dropDownList(
            \yii\helpers\ArrayHelper::map(open20\amos\cwh\models\CwhRegolePubblicazione::find()->all(), 'id', 'id'),
            ['prompt' => AmosCwh::t('amoscwh', 'Select')]
        ); ?>
    </div>
